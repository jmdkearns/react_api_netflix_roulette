...
/***/ function(module, exports, __webpack_require__) {
	...
	var MoviesBox = __webpack_require__(159);
	
	window.onload = function () {
	  ReactDOM.render(React.createElement(MoviesBox, null), document.getElementById('app'));
	};
	...
	var MoviesBox = React.createClass({
	  ...
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(MovieSelect, { movies: this.state.movies }),
	      React.createElement(MovieDetail, { movie: this.state.currentMovie })
	    );
	  }
	});
	...
	var MovieSelect = React.createClass({
	  ...
	  render: function render() {
	    var movies = this.props.movies.map(function (movie, index) {
	      return React.createElement('img', { src: movie.poster, value: index, key: index });
	    }.bind(this));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MovieDetail = function MovieDetail(props) {
	  if (!props.movie) return React.createElement(
	    'h4',
	    null,
